# WebService::Fastly::Object::RealtimeMeasurements
...
**hits_time** | **double** | Total amount of time spent processing cache hits (in seconds). | [optional] 
**miss_time** | **double** | Total amount of time spent processing cache misses (in seconds). | [optional] 
...
**fetch_sub_time** | **double** | Time spent inside the `vcl_fetch` Varnish subroutine (in nanoseconds). | [optional] 
...
**object_store_read_requests** | **int** | The total number of reads received for the object store. | [optional] 
**object_store_write_requests** | **int** | The total number of writes received for the object store. | [optional] 
