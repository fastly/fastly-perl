...
# **create_log_loggly**
> LoggingLogglyResponse create_log_loggly(service_id => $service_id, version_id => $version_id, name => $name, placement => $placement, response_condition => $response_condition, format => $format, format_version => $format_version, token => $token)
...
eval {
    my $result = $api_instance->create_log_loggly(service_id => $service_id, version_id => $version_id, name => $name, placement => $placement, response_condition => $response_condition, format => $format, format_version => $format_version, token => $token);
    print Dumper($result);
};
if ($@) {
...
# **update_log_loggly**
> LoggingLogglyResponse update_log_loggly(service_id => $service_id, version_id => $version_id, logging_loggly_name => $logging_loggly_name, name => $name, placement => $placement, response_condition => $response_condition, format => $format, format_version => $format_version, token => $token)
...
eval {
    my $result = $api_instance->update_log_loggly(service_id => $service_id, version_id => $version_id, logging_loggly_name => $logging_loggly_name, name => $name, placement => $placement, response_condition => $response_condition, format => $format, format_version => $format_version, token => $token);
    print Dumper($result);
};
if ($@) {
