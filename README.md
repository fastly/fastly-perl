...
> ⚠️ This client library (`2.01-TRIAL`)  is an early-access release. Features may change without notice. Use at your own risk.
...
*EntitledProductsApi* | [**get_entitled_product**](docs/EntitledProductsApi.md#get_entitled_product) | **GET** /entitled-products/{product_id} | Get entitled product
...
[bug]: https://github.com/fastly/fastly-perl/issues/new?labels=bug
