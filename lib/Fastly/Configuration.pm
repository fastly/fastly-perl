...
use constant VERSION => '2.0.0-alpha1';

=head1 Name

        Fastly::Configuration - holds the configuration for all Fastly Modules
...
default: fastly-perl/2.0.0-alpha1
...
sub new {
    ...
    $p{http_timeout} //= 180;
    $p{http_user_agent} //= 'fastly-perl/2.0.0-alpha1';
