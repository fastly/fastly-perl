...
#
package Fastly::LoggingSplunkApi;
...
# @param string $tls_ca_cert A secure certificate to authenticate a server with. Must be in PEM format. (optional)
# @param string $tls_client_cert The client certificate used to make authenticated requests. Must be in PEM format. (optional)
# @param string $tls_client_key The client private key used to make authenticated requests. Must be in PEM format. (optional)
# @param string $tls_hostname The hostname to verify the server&#39;s certificate. This should be one of the Subject Alternative Name (SAN) fields for the certificate. Common Names (CN) are not supported. (optional)
...
# @param LoggingUseTls $use_tls  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_log_splunk' } = {
        summary => 'Create a Splunk log endpoint',
        params => $params,
        returns => 'LoggingSplunkResponse',
        };
}
# @return LoggingSplunkResponse
#
sub create_log_splunk {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling create_log_splunk");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling create_log_splunk");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/splunk';
    ...
    my $_response_object = $self->{api_client}->deserialize('LoggingSplunkResponse', $response);
...
# @param string $logging_splunk_name The name for the real-time logging configuration. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_log_splunk' } = {
...
#
sub delete_log_splunk {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling delete_log_splunk");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling delete_log_splunk");
    }

    # verify the required parameter 'logging_splunk_name' is set
    unless (exists $args{'logging_splunk_name'}) {
      croak("Missing the required parameter 'logging_splunk_name' when calling delete_log_splunk");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/splunk/{logging_splunk_name}';
    ...
    # path params
    if ( exists $args{'logging_splunk_name'}) {
        my $_base_variable = "{" . "logging_splunk_name" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'logging_splunk_name'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
...
# @param string $logging_splunk_name The name for the real-time logging configuration. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_log_splunk' } = {
...
sub get_log_splunk {
    ...
    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling get_log_splunk");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling get_log_splunk");
    }

    # verify the required parameter 'logging_splunk_name' is set
    unless (exists $args{'logging_splunk_name'}) {
      croak("Missing the required parameter 'logging_splunk_name' when calling get_log_splunk");
    }
...
# @param int $version_id Integer identifying a service version. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_log_splunk' } = {
        summary => 'List Splunk log endpoints',
        params => $params,
        returns => 'ARRAY[LoggingSplunkResponse]',
        };
}
...
sub list_log_splunk {
    ...
    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling list_log_splunk");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling list_log_splunk");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[LoggingSplunkResponse]', $response);
    return $_response_object;
}
...
# @param LoggingUseTls $use_tls  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_log_splunk' } = {
...
# @return LoggingSplunkResponse
#
sub update_log_splunk {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling update_log_splunk");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling update_log_splunk");
    }

    # verify the required parameter 'logging_splunk_name' is set
    unless (exists $args{'logging_splunk_name'}) {
      croak("Missing the required parameter 'logging_splunk_name' when calling update_log_splunk");
    }
