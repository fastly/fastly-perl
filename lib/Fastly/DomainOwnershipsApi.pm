...
#
package Fastly::DomainOwnershipsApi;
...
#
{
    ...
    __PACKAGE__->method_documentation->{ 'list_domain_ownerships' } = {
        ...
        params => $params,
        returns => 'ListDomainOwnerships200Response',
        };
}
# @return ListDomainOwnerships200Response
#
sub list_domain_ownerships {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/domain-ownerships';
    ...
    my $_response_object = $self->{api_client}->deserialize('ListDomainOwnerships200Response', $response);
