...
#
{
    ...
    __PACKAGE__->method_documentation->{ 'list_service_stars' } = {
        summary => 'List stars',
        params => $params,
        returns => 'ListServiceStars200Response',
        };
}
# @return ListServiceStars200Response
#
sub list_service_stars {
    ...
    my $_response_object = $self->{api_client}->deserialize('ListServiceStars200Response', $response);
    return $_response_object;
}
