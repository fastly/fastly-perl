...
#
package Fastly::LoggingAzureblobApi;
...
# @param string $public_key A PGP public key that Fastly will use to encrypt your log files before writing them to disk. (optional)
# @param int $file_max_bytes The maximum number of bytes for each uploaded file. A value of 0 can be used to indicate there is no limit on the size of uploaded files, otherwise the minimum value is 1048576 bytes (1 MiB.) (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_log_azure' } = {
        summary => 'Create an Azure Blob Storage log endpoint',
        params => $params,
        returns => 'LoggingAzureblobResponse',
        };
}
# @return LoggingAzureblobResponse
#
sub create_log_azure {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling create_log_azure");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling create_log_azure");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/azureblob';
    ...
    if ( exists $args{'container'} ) {
                $form_params->{'container'} = $self->{api_client}->to_form_value($args{'container'});
    }

    # form params
    if ( exists $args{'sas_token'} ) {
                $form_params->{'sas_token'} = $self->{api_client}->to_form_value($args{'sas_token'});
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('LoggingAzureblobResponse', $response);
...
# @param string $logging_azureblob_name The name for the real-time logging configuration. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_log_azure' } = {
...
#
sub delete_log_azure {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling delete_log_azure");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling delete_log_azure");
    }

    # verify the required parameter 'logging_azureblob_name' is set
    unless (exists $args{'logging_azureblob_name'}) {
      croak("Missing the required parameter 'logging_azureblob_name' when calling delete_log_azure");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/azureblob/{logging_azureblob_name}';
    ...
    # path params
    if ( exists $args{'logging_azureblob_name'}) {
        my $_base_variable = "{" . "logging_azureblob_name" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'logging_azureblob_name'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
...
# @param string $logging_azureblob_name The name for the real-time logging configuration. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_log_azure' } = {
...
sub get_log_azure {
    ...
    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling get_log_azure");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling get_log_azure");
    }

    # verify the required parameter 'logging_azureblob_name' is set
    unless (exists $args{'logging_azureblob_name'}) {
      croak("Missing the required parameter 'logging_azureblob_name' when calling get_log_azure");
    }
...
# @param int $version_id Integer identifying a service version. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_log_azure' } = {
        summary => 'List Azure Blob Storage log endpoints',
        params => $params,
        returns => 'ARRAY[LoggingAzureblobResponse]',
        };
}
...
sub list_log_azure {
    ...
    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling list_log_azure");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling list_log_azure");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[LoggingAzureblobResponse]', $response);
    return $_response_object;
}
...
# @param int $file_max_bytes The maximum number of bytes for each uploaded file. A value of 0 can be used to indicate there is no limit on the size of uploaded files, otherwise the minimum value is 1048576 bytes (1 MiB.) (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_log_azure' } = {
...
# @return LoggingAzureblobResponse
#
sub update_log_azure {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling update_log_azure");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling update_log_azure");
    }

    # verify the required parameter 'logging_azureblob_name' is set
    unless (exists $args{'logging_azureblob_name'}) {
      croak("Missing the required parameter 'logging_azureblob_name' when calling update_log_azure");
    }
