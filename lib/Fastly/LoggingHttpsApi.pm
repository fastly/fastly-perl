...
#
package Fastly::LoggingHttpsApi;
...
# @param string $content_type Content type of the header sent with the request. (optional)
# @param string $header_name Name of the custom header sent with the request. (optional)
# @param LoggingMessageType $message_type  (optional)
# @param string $header_value Value of the custom header sent with the request. (optional)
