...
#
package Fastly::TlsSubscriptionsApi;
...
# @param HASH[string,AnyType] $request_body  (optional)
{
    my $params = {
    'tls_subscription_id' => {
        data_type => 'string',
...
# @param string $include Include related objects. Optional, comma-separated values. Permitted values: &#x60;tls_authorizations&#x60; and &#x60;tls_authorizations.globalsign_email_challenge&#x60;.  (optional)
{
    ...
    'include' => {
        data_type => 'string',
        description => 'Include related objects. Optional, comma-separated values. Permitted values: &#x60;tls_authorizations&#x60; and &#x60;tls_authorizations.globalsign_email_challenge&#x60;. ',
        required => '0',
    },
    };
