...
# @param string $redundancy The S3 redundancy level. (optional)
# @param string $secret_key The secret key for your S3 account. Not required if &#x60;iam_role&#x60; is provided. (optional)
# @param string $server_side_encryption_kms_key_id Optional server-side KMS Key Id. Must be set if &#x60;server_side_encryption&#x60; is set to &#x60;aws:kms&#x60; or &#x60;AES256&#x60;. (optional)
# @param string $server_side_encryption Set this to &#x60;AES256&#x60; or &#x60;aws:kms&#x60; to enable S3 Server Side Encryption. (optional)
{
    my $params = {
    'service_id' => {
        data_type => 'string',
