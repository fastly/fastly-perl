...
sub create_log_gcs {
    ...
    my $_response_object = $self->{api_client}->deserialize('LoggingGcsResponse', $response);
...
# @param string $logging_gcs_name The name for the real-time logging configuration. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_log_gcs' } = {
...
sub delete_log_gcs {
    ...
    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling delete_log_gcs");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling delete_log_gcs");
    }

    # verify the required parameter 'logging_gcs_name' is set
    unless (exists $args{'logging_gcs_name'}) {
      croak("Missing the required parameter 'logging_gcs_name' when calling delete_log_gcs");
    }
    ...
    # path params
    if ( exists $args{'logging_gcs_name'}) {
        my $_base_variable = "{" . "logging_gcs_name" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'logging_gcs_name'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
...
# @param string $logging_gcs_name The name for the real-time logging configuration. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_log_gcs' } = {
...
sub get_log_gcs {
    ...
    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling get_log_gcs");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling get_log_gcs");
    }

    # verify the required parameter 'logging_gcs_name' is set
    unless (exists $args{'logging_gcs_name'}) {
      croak("Missing the required parameter 'logging_gcs_name' when calling get_log_gcs");
    }
...
# @param int $version_id Integer identifying a service version. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_log_gcs' } = {
        summary => 'List GCS log endpoints',
        params => $params,
        returns => 'ARRAY[LoggingGcsResponse]',
        };
}
...
sub list_log_gcs {
    ...
    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling list_log_gcs");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling list_log_gcs");
    }
