...
#
package WebService::Fastly::LoggingLogshuttleApi;
...
# @param string $url The URL to stream logs to. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_log_logshuttle' } = {
        summary => 'Create a Log Shuttle log endpoint',
        params => $params,
        returns => 'LoggingLogshuttleResponse',
        };
}
# @return LoggingLogshuttleResponse
#
sub create_log_logshuttle {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling create_log_logshuttle");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling create_log_logshuttle");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/logshuttle';
    ...
    my $_response_object = $self->{api_client}->deserialize('LoggingLogshuttleResponse', $response);
...
# @param string $service_id Alphanumeric string identifying the service. (required)
# @param int $version_id Integer identifying a service version. (required)
# @param string $logging_logshuttle_name The name for the real-time logging configuration. (required)
{
    my $params = {
    'service_id' => {
        data_type => 'string',
    ...
    __PACKAGE__->method_documentation->{ 'delete_log_logshuttle' } = {
...
#
sub delete_log_logshuttle {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling delete_log_logshuttle");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling delete_log_logshuttle");
    }

    # verify the required parameter 'logging_logshuttle_name' is set
    unless (exists $args{'logging_logshuttle_name'}) {
      croak("Missing the required parameter 'logging_logshuttle_name' when calling delete_log_logshuttle");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/logshuttle/{logging_logshuttle_name}';
    ...
    # path params
    if ( exists $args{'logging_logshuttle_name'}) {
        my $_base_variable = "{" . "logging_logshuttle_name" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'logging_logshuttle_name'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
...
# @param string $logging_logshuttle_name The name for the real-time logging configuration. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_log_logshuttle' } = {
...
# @return LoggingLogshuttleResponse
#
sub get_log_logshuttle {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling get_log_logshuttle");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling get_log_logshuttle");
    }

    # verify the required parameter 'logging_logshuttle_name' is set
    unless (exists $args{'logging_logshuttle_name'}) {
      croak("Missing the required parameter 'logging_logshuttle_name' when calling get_log_logshuttle");
    }
...
# @param int $version_id Integer identifying a service version. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_log_logshuttle' } = {
        summary => 'List Log Shuttle log endpoints',
        params => $params,
        returns => 'ARRAY[LoggingLogshuttleResponse]',
        };
}
# @return ARRAY[LoggingLogshuttleResponse]
#
sub list_log_logshuttle {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling list_log_logshuttle");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling list_log_logshuttle");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[LoggingLogshuttleResponse]', $response);
    return $_response_object;
}
...
# @param string $url The URL to stream logs to. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_log_logshuttle' } = {
...
# @return LoggingLogshuttleResponse
#
sub update_log_logshuttle {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling update_log_logshuttle");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling update_log_logshuttle");
    }

    # verify the required parameter 'logging_logshuttle_name' is set
    unless (exists $args{'logging_logshuttle_name'}) {
      croak("Missing the required parameter 'logging_logshuttle_name' when calling update_log_logshuttle");
    }
