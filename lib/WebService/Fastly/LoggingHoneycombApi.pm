...
#
package WebService::Fastly::LoggingHoneycombApi;
...
# @param string $format A Fastly [log format string](https://www.fastly.com/documentation/guides/integrations/streaming-logs/custom-log-formats/). Must produce valid JSON that Honeycomb can ingest. (optional)
...
# @param string $token The Write Key from the Account page of your Honeycomb account. (optional)
{
    ...
    'format' => {
        data_type => 'string',
        description => 'A Fastly [log format string](https://www.fastly.com/documentation/guides/integrations/streaming-logs/custom-log-formats/). Must produce valid JSON that Honeycomb can ingest.',
        required => '0',
    },
...
sub create_log_honeycomb {
    ...
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling create_log_honeycomb");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling create_log_honeycomb");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/honeycomb';
...
# @param string $logging_honeycomb_name The name for the real-time logging configuration. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_log_honeycomb' } = {
...
#
sub delete_log_honeycomb {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling delete_log_honeycomb");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling delete_log_honeycomb");
    }

    # verify the required parameter 'logging_honeycomb_name' is set
    unless (exists $args{'logging_honeycomb_name'}) {
      croak("Missing the required parameter 'logging_honeycomb_name' when calling delete_log_honeycomb");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/honeycomb/{logging_honeycomb_name}';
    ...
    # path params
    if ( exists $args{'logging_honeycomb_name'}) {
        my $_base_variable = "{" . "logging_honeycomb_name" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'logging_honeycomb_name'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
...
sub get_log_honeycomb {
    ...
    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling get_log_honeycomb");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling get_log_honeycomb");
    }

    # verify the required parameter 'logging_honeycomb_name' is set
    unless (exists $args{'logging_honeycomb_name'}) {
      croak("Missing the required parameter 'logging_honeycomb_name' when calling get_log_honeycomb");
    }
...
# @param int $version_id Integer identifying a service version. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_log_honeycomb' } = {
        summary => 'List Honeycomb log endpoints',
        params => $params,
        returns => 'ARRAY[LoggingHoneycombResponse]',
        };
}
# @return ARRAY[LoggingHoneycombResponse]
#
sub list_log_honeycomb {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling list_log_honeycomb");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling list_log_honeycomb");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[LoggingHoneycombResponse]', $response);
    return $_response_object;
}
...
# @param string $token The Write Key from the Account page of your Honeycomb account. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_log_honeycomb' } = {
...
# @return LoggingHoneycombResponse
#
sub update_log_honeycomb {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling update_log_honeycomb");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling update_log_honeycomb");
    }

    # verify the required parameter 'logging_honeycomb_name' is set
    unless (exists $args{'logging_honeycomb_name'}) {
      croak("Missing the required parameter 'logging_honeycomb_name' when calling update_log_honeycomb");
    }
