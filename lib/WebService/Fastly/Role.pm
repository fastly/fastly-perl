...
#
package WebService::Fastly::Role;
use utf8;
...
has api_factory => ( is => 'ro',
                     isa => 'WebService::Fastly::ApiFactory',
                     builder => '_build_af',
                     lazy => 1,
...
has _cfg => ( is => 'ro',
              isa => 'WebService::Fastly::Configuration',
              default => sub { WebService::Fastly::Configuration->new() },
              );
...
sub _build_af {
    ...
    return WebService::Fastly::ApiFactory->new(%args);
}
