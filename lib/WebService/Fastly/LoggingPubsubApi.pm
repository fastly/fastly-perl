...
#
package WebService::Fastly::LoggingPubsubApi;
...
# @param string $project_id Your Google Cloud Platform project ID. Required (optional)
{
    ...
    'user' => {
        data_type => 'string',
        description => 'Your Google Cloud Platform service account email address. The &#x60;client_email&#x60; field in your service account authentication JSON. Required.',
        required => '0',
    },
    'secret_key' => {
        data_type => 'string',
        description => 'Your Google Cloud Platform account secret key. The &#x60;private_key&#x60; field in your service account authentication JSON. Required.',
        required => '0',
    },
    'topic' => {
        data_type => 'string',
    ...
    __PACKAGE__->method_documentation->{ 'create_log_gcp_pubsub' } = {
        summary => 'Create a GCP Cloud Pub/Sub log endpoint',
        params => $params,
        returns => 'LoggingGooglePubsubResponse',
        };
}
# @return LoggingGooglePubsubResponse
#
sub create_log_gcp_pubsub {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling create_log_gcp_pubsub");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling create_log_gcp_pubsub");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/pubsub';
    ...
    my $_response_object = $self->{api_client}->deserialize('LoggingGooglePubsubResponse', $response);
...
# @param string $logging_google_pubsub_name The name for the real-time logging configuration. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_log_gcp_pubsub' } = {
...
#
sub delete_log_gcp_pubsub {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling delete_log_gcp_pubsub");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling delete_log_gcp_pubsub");
    }

    # verify the required parameter 'logging_google_pubsub_name' is set
    unless (exists $args{'logging_google_pubsub_name'}) {
      croak("Missing the required parameter 'logging_google_pubsub_name' when calling delete_log_gcp_pubsub");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/pubsub/{logging_google_pubsub_name}';
    ...
    # path params
    if ( exists $args{'logging_google_pubsub_name'}) {
        my $_base_variable = "{" . "logging_google_pubsub_name" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'logging_google_pubsub_name'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
...
# @param string $logging_google_pubsub_name The name for the real-time logging configuration. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_log_gcp_pubsub' } = {
...
# @return LoggingGooglePubsubResponse
#
sub get_log_gcp_pubsub {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling get_log_gcp_pubsub");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling get_log_gcp_pubsub");
    }

    # verify the required parameter 'logging_google_pubsub_name' is set
    unless (exists $args{'logging_google_pubsub_name'}) {
      croak("Missing the required parameter 'logging_google_pubsub_name' when calling get_log_gcp_pubsub");
    }
...
# @param int $version_id Integer identifying a service version. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_log_gcp_pubsub' } = {
        summary => 'List GCP Cloud Pub/Sub log endpoints',
        params => $params,
        returns => 'ARRAY[LoggingGooglePubsubResponse]',
        };
}
# @return ARRAY[LoggingGooglePubsubResponse]
#
sub list_log_gcp_pubsub {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling list_log_gcp_pubsub");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling list_log_gcp_pubsub");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[LoggingGooglePubsubResponse]', $response);
    return $_response_object;
}
...
# @param string $project_id Your Google Cloud Platform project ID. Required (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_log_gcp_pubsub' } = {
...
# @return LoggingGooglePubsubResponse
#
sub update_log_gcp_pubsub {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling update_log_gcp_pubsub");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling update_log_gcp_pubsub");
    }

    # verify the required parameter 'logging_google_pubsub_name' is set
    unless (exists $args{'logging_google_pubsub_name'}) {
      croak("Missing the required parameter 'logging_google_pubsub_name' when calling update_log_gcp_pubsub");
    }
