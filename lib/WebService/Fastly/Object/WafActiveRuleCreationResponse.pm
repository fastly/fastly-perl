...
#
package WebService::Fastly::Object::WafActiveRuleCreationResponse;
...
__PACKAGE__->method_documentation({
    'data' => {
        datatype => 'ARRAY[WafActiveRuleResponseData]',
        base_name => 'data',
        description => '',
        format => '',
        read_only => 'false',
    ...
    'included' => {
        datatype => 'ARRAY[IncludedWithWafActiveRuleItem]',
        base_name => 'included',
        description => '',
        format => '',
        read_only => 'false',
...
__PACKAGE__->openapi_types( {
    'data' => 'ARRAY[WafActiveRuleResponseData]',
    'links' => 'PaginationLinks',
    'meta' => 'PaginationMeta',
    'included' => 'ARRAY[IncludedWithWafActiveRuleItem]'
} );
