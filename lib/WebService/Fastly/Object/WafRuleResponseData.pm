...
#
package WebService::Fastly::Object::WafRuleResponseData;
...
__PACKAGE__->method_documentation({
    ...
    'relationships' => {
        datatype => 'RelationshipsForWafRule',
...
__PACKAGE__->openapi_types( {
    ...
    'relationships' => 'RelationshipsForWafRule'
} );
