...
#
package WebService::Fastly::Object::DashboardItemPropertyVisualization;
...
__PACKAGE__->class_documentation({description => '[An object](#visualization) which describes the data visualization to display. ',
...
__PACKAGE__->method_documentation({
    ...
    'config' => {
        datatype => 'DashboardItemPropertyVisualizationPropertyConfig',
        base_name => 'config',
        description => '',
        format => '',
        read_only => 'false',
