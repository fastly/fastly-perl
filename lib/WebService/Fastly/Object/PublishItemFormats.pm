...
#
package WebService::Fastly::Object::PublishItemFormats;
...
__PACKAGE__->method_documentation({
    'http_response' => {
        datatype => 'HttpResponseFormat',
        base_name => 'http-response',
        description => '',
        format => '',
        read_only => 'false',
            },
    'http_stream' => {
        datatype => 'HttpStreamFormat',
        base_name => 'http-stream',
        description => '',
        format => '',
        read_only => 'false',
            },
    'ws_message' => {
        datatype => 'WsMessageFormat',
        base_name => 'ws-message',
        description => '',
        format => '',
        read_only => 'false',
            },
