...
#
package WebService::Fastly::Object::KvStoreUpsertBatch;
...
__PACKAGE__->method_documentation({
    'key' => {
        datatype => 'string',
        base_name => 'key',
        description => 'The key of the item to be added, updated, retrieved, or deleted.',
        format => '',
        read_only => 'false',
            },
    'time_to_live_sec' => {
        datatype => 'int',
        base_name => 'time_to_live_sec',
