...
#
package WebService::Fastly::Object::ImageOptimizerResponseBodyGetAllServices;
...
use WebService::Fastly::Object::ImageOptimizerResponseProductProduct;
...
__PACKAGE__->method_documentation({
    'product' => {
        datatype => 'ImageOptimizerResponseProductProduct',
        base_name => 'product',
        description => '',
        format => '',
        read_only => 'false',
    ...
    '_links' => {
        datatype => 'ImageOptimizerResponseLinksGetAllServicesLinks',
        base_name => '_links',
        description => '',
        format => '',
        read_only => 'false',
...
__PACKAGE__->openapi_types( {
    ...
    '_links' => 'ImageOptimizerResponseLinksGetAllServicesLinks'
} );
