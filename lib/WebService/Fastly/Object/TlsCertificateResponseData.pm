...
#
package WebService::Fastly::Object::TlsCertificateResponseData;
...
__PACKAGE__->method_documentation({
    ...
    'attributes' => {
        datatype => 'TlsCertificateResponseAttributes',
    ...
    'relationships' => {
        datatype => 'RelationshipTlsDomains',
