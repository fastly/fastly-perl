...
#
package WebService::Fastly::Object::LogAggregationsGetResponseMeta;
...
__PACKAGE__->method_documentation({
    ...
    'sort' => {
        datatype => 'string',
        base_name => 'sort',
        description => 'Comma-separated list of the series names whose values were used to sort the results.',
        format => '',
        read_only => 'false',
            },
    'filters' => {
        datatype => 'LogAggregationsGetResponseMetaFilters',
        base_name => 'filters',
        description => '',
        format => '',
        read_only => 'false',
...
__PACKAGE__->openapi_types( {
    ...
    'limit' => 'int',
    'sort' => 'string',
    'filters' => 'LogAggregationsGetResponseMetaFilters'
} );
