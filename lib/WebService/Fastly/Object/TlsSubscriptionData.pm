...
#
package WebService::Fastly::Object::TlsSubscriptionData;
...
__PACKAGE__->method_documentation({
    ...
    'attributes' => {
        datatype => 'TlsSubscriptionDataAttributes',
    ...
    'relationships' => {
        datatype => 'RelationshipsForTlsSubscription',
