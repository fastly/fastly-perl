...
#
package WebService::Fastly::Object::ComputeAclList;
...
__PACKAGE__->method_documentation({
    'data' => {
        datatype => 'ARRAY[ComputeAclCreateAclsResponse]',
        base_name => 'data',
        description => '',
        format => '',
        read_only => 'false',
...
__PACKAGE__->openapi_types( {
    'data' => 'ARRAY[ComputeAclCreateAclsResponse]',
    'meta' => 'ComputeAclListMeta'
} );
