...
#
package WebService::Fastly::Object::WafActiveRuleResponseData;
...
__PACKAGE__->method_documentation({
    ...
    'attributes' => {
        datatype => 'WafActiveRuleResponseDataAttributes',
    ...
    'relationships' => {
        datatype => 'WafActiveRuleResponseDataRelationships',
...
__PACKAGE__->openapi_types( {
    ...
    'relationships' => 'WafActiveRuleResponseDataRelationships',
    'id' => 'string'
} );
