...
#
package WebService::Fastly::Object::PackageMetadata;
...
__PACKAGE__->class_documentation({description => '[Package metadata](#metadata-model) that has been extracted from the uploaded package. ',
...
__PACKAGE__->method_documentation({
    ...
    'language' => {
        datatype => 'string',
        base_name => 'language',
        description => 'The language of the Compute@Edge package.',
        format => '',
        read_only => 'false',
            },
    'size' => {
    ...
    'hashsum' => {
        datatype => 'string',
        base_name => 'hashsum',
        description => 'Hash of the Compute@Edge package.',
        format => '',
        read_only => 'false',
            },
});
