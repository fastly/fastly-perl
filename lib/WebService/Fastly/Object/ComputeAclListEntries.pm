...
#
package WebService::Fastly::Object::ComputeAclListEntries;
...
__PACKAGE__->method_documentation({
    'meta' => {
        datatype => 'ComputeAclListEntriesMeta',
        base_name => 'meta',
        description => '',
        format => '',
        read_only => 'false',
    ...
    'entries' => {
        datatype => 'ARRAY[ComputeAclListEntriesItem]',
        base_name => 'entries',
        description => '',
        format => '',
        read_only => 'false',
...
__PACKAGE__->openapi_types( {
    'meta' => 'ComputeAclListEntriesMeta',
    'entries' => 'ARRAY[ComputeAclListEntriesItem]'
} );
