...
#
package WebService::Fastly::Object::RelationshipsForTlsBulkCertificate;
...
__PACKAGE__->method_documentation({
    'tls_configurations' => {
        datatype => 'RelationshipTlsConfigurationsTlsConfigurations',
        base_name => 'tls_configurations',
        description => '',
        format => '',
        read_only => 'false',
            },
...
__PACKAGE__->openapi_types( {
    'tls_configurations' => 'RelationshipTlsConfigurationsTlsConfigurations',
