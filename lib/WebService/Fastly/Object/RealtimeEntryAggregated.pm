...
__PACKAGE__->method_documentation({
    ...
    'compute_service_bereq_error' => {
        datatype => 'int',
        base_name => 'compute_service_bereq_error',
        description => 'Number of backend request errors, including timeouts.',
        format => 'int64',
        read_only => 'false',
            },
    ...
    'compute_service_memory_exceeded_error' => {
        datatype => 'int',
        base_name => 'compute_service_memory_exceeded_error',
        description => 'Number of times a guest exceeded its heap limit.',
        format => 'int64',
        read_only => 'false',
            },
    ...
    'imgopto_avif_count' => {
        datatype => 'int',
        base_name => 'imgopto_avif_count',
        description => 'Count of AVIF images delivered to end user by Image Optimizer.',
        format => '',
        read_only => 'false',
            },
    'imgopto_jpeg_count' => {
        datatype => 'int',
        base_name => 'imgopto_jpeg_count',
        description => 'Count of JPEG images delivered to end user by Image Optimizer.',
        format => '',
        read_only => 'false',
            },
    'imgopto_png_count' => {
        datatype => 'int',
        base_name => 'imgopto_png_count',
        description => 'Count of PNG images delivered to end user by Image Optimizer.',
        format => '',
        read_only => 'false',
            },
    'imgopto_gif_count' => {
        datatype => 'int',
        base_name => 'imgopto_gif_count',
        description => 'Count of GIF images delivered to end user by Image Optimizer.',
        format => '',
        read_only => 'false',
            },
    'imgopto_webp_count' => {
        datatype => 'int',
        base_name => 'imgopto_webp_count',
        description => 'Count of WebP images delivered to end user by Image Optimizer.',
        format => '',
        read_only => 'false',
            },
    'imgopto_jpegxl_count' => {
        datatype => 'int',
        base_name => 'imgopto_jpegxl_count',
        description => 'Count of JPEGXL images delivered to end user by Image Optimizer.',
        format => '',
        read_only => 'false',
            },
    'imgopto_svg_count' => {
        datatype => 'int',
        base_name => 'imgopto_svg_count',
        description => 'Count of SVG images delivered to end user by Image Optimizer.',
        format => '',
        read_only => 'false',
            },
    'imgopto_mp4_count' => {
        datatype => 'int',
        base_name => 'imgopto_mp4_count',
        description => 'Count of MP4s delivered to end user by Image Optimizer.',
        format => '',
        read_only => 'false',
            },
    'compute_service_resource_limits_error' => {
        datatype => 'int',
        base_name => 'compute_service_resource_limits_error',
        description => 'Aggregate of fatal errors caused by exceeding allocated resource limits, specifically runtime duration, vCPU usage, and heap memory limits.',
        format => '',
        read_only => 'false',
            },
    'compute_service_runtime_error' => {
        datatype => 'int',
        base_name => 'compute_service_runtime_error',
        description => 'Fatal errors caused by service logic faults, including stack overflows, unreachable code traps, illegal memory access, or attempts to send multiple responses.',
        format => '',
        read_only => 'false',
            },
    'compute_service_chain_error' => {
        datatype => 'int',
        base_name => 'compute_service_chain_error',
        description => 'Fatal errors caused by the service path exceeding hop or service limits, or where a forwarding loop is detected via CDN-Loop headers.',
        format => '',
        read_only => 'false',
            },
    'compute_platform_internal_error' => {
        datatype => 'int',
        base_name => 'compute_platform_internal_error',
        description => 'Fatal errors caused by internal errors in Fastly’s Compute platform.',
        format => '',
        read_only => 'false',
            },
    'compute_service_timeout_error' => {
        datatype => 'int',
        base_name => 'compute_service_timeout_error',
        description => 'Fatal errors caused by exceeding the per-request runtime limit.',
        format => '',
        read_only => 'false',
            },
    'compute_service_vcpu_exceeded_error' => {
        datatype => 'int',
        base_name => 'compute_service_vcpu_exceeded_error',
        description => 'Fatal errors caused by exceeding the per-request vCPU time limit.',
        format => '',
        read_only => 'false',
            },
    'compute_service_limits_error' => {
        datatype => 'int',
        base_name => 'compute_service_limits_error',
        description => 'Non-fatal errors caused by attempts to exceed defined operational limits, such as simultaneous backend requests or cache transactions.',
        format => '',
        read_only => 'false',
            },
    'compute_platform_invalid_request_error' => {
        datatype => 'int',
        base_name => 'compute_platform_invalid_request_error',
        description => 'Fatal errors caused by unprocessable requests to the service, such as requests with malformed CDN-Loop headers or invalid purge credentials.',
        format => '',
        read_only => 'false',
            },
});
