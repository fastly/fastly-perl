...
#
package WebService::Fastly::Object::TlsPrivateKeyData;
...
__PACKAGE__->method_documentation({
    ...
    'attributes' => {
        datatype => 'TlsPrivateKeyDataAttributes',
    ...
    'relationships' => {
        datatype => 'RelationshipsForTlsPrivateKey',
