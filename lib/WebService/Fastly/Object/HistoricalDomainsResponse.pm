...
#
package WebService::Fastly::Object::HistoricalDomainsResponse;
...
use WebService::Fastly::Object::DomainInspectorEntry;
...
__PACKAGE__->method_documentation({
    ...
    'meta' => {
        datatype => 'HistoricalDomainsMeta',
        base_name => 'meta',
        description => '',
        format => '',
        read_only => 'false',
    ...
    'data' => {
        datatype => 'ARRAY[DomainInspectorEntry]',
        base_name => 'data',
...
__PACKAGE__->openapi_types( {
    ...
    'msg' => 'string',
    'data' => 'ARRAY[DomainInspectorEntry]'
} );
