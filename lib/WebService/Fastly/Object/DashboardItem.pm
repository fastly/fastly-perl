...
#
package WebService::Fastly::Object::DashboardItem;
...
__PACKAGE__->class_documentation({description => 'A dashboard item. Typically a data visualization like a chart.',
                                  class => 'DashboardItem',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'data_source' => {
        datatype => 'DashboardItemPropertyDataSource',
    ...
    'visualization' => {
        datatype => 'DashboardItemPropertyVisualization',
