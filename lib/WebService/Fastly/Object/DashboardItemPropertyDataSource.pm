...
#
package WebService::Fastly::Object::DashboardItemPropertyDataSource;
...
__PACKAGE__->class_documentation({description => '[An object](#data-source) which describes the data to display.',
...
__PACKAGE__->method_documentation({
    ...
    'config' => {
        datatype => 'DashboardItemPropertyDataSourcePropertyConfig',
        base_name => 'config',
        description => '',
        format => '',
        read_only => 'false',
