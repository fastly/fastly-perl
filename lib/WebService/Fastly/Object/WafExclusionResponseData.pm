...
#
package WebService::Fastly::Object::WafExclusionResponseData;
...
__PACKAGE__->method_documentation({
    ...
    'attributes' => {
        datatype => 'WafExclusionResponseDataAttributes',
    ...
    'relationships' => {
        datatype => 'WafExclusionResponseDataRelationships',
    ...
    'id' => {
        datatype => 'string',
        base_name => 'id',
        description => 'Alphanumeric string identifying a WAF exclusion.',
        format => '',
        read_only => 'true',
            },
});
...
__PACKAGE__->openapi_types( {
    ...
    'relationships' => 'WafExclusionResponseDataRelationships',
    'id' => 'string'
} );
