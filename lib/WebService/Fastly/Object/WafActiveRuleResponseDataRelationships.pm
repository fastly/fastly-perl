...
#
package WebService::Fastly::Object::WafActiveRuleResponseDataRelationships;
...
__PACKAGE__->method_documentation({
    'waf_firewall_version' => {
        datatype => 'RelationshipWafFirewallVersionWafFirewallVersion',
        base_name => 'waf_firewall_version',
        description => '',
        format => '',
        read_only => 'false',
            },
    'waf_rule_revisions' => {
        datatype => 'RelationshipWafRuleRevisionWafRuleRevisions',
        base_name => 'waf_rule_revisions',
        description => '',
        format => '',
        read_only => 'false',
            },
...
__PACKAGE__->openapi_types( {
    'waf_firewall_version' => 'RelationshipWafFirewallVersionWafFirewallVersion',
    'waf_rule_revisions' => 'RelationshipWafRuleRevisionWafRuleRevisions'
} );
