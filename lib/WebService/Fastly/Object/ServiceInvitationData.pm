...
#
package WebService::Fastly::Object::ServiceInvitationData;
...
__PACKAGE__->method_documentation({
    'type' => {
        datatype => 'TypeServiceInvitation',
        base_name => 'type',
        description => '',
        format => '',
        read_only => 'false',
    ...
    'attributes' => {
        datatype => 'ServiceInvitationDataAttributes',
    ...
    'relationships' => {
        datatype => 'RelationshipService',
        base_name => 'relationships',
        description => 'Service the accepting user will have access to.',
        format => '',
        read_only => 'false',
            },
});
