...
#
package WebService::Fastly::Object::AiAcceleratorResponseBodyEnable;
...
use WebService::Fastly::Object::AiAcceleratorResponseProductProduct;
...
__PACKAGE__->method_documentation({
    'product' => {
        datatype => 'AiAcceleratorResponseProductProduct',
        base_name => 'product',
        description => '',
        format => '',
        read_only => 'false',
    ...
    '_links' => {
        datatype => 'AiAcceleratorResponseLinksLinks',
        base_name => '_links',
        description => '',
        format => '',
        read_only => 'false',
...
__PACKAGE__->openapi_types( {
    'product' => 'AiAcceleratorResponseProductProduct',
    'customer' => 'AiAcceleratorResponseCustomerCustomer',
    '_links' => 'AiAcceleratorResponseLinksLinks'
} );
