...
#
package WebService::Fastly::Object::WebsocketsResponseBodyGetAllServices;
...
use WebService::Fastly::Object::WebsocketsResponseCustomer;
...
__PACKAGE__->method_documentation({
    'product' => {
        datatype => 'WebsocketsResponseProductProduct',
        base_name => 'product',
        description => '',
        format => '',
        read_only => 'false',
    ...
    '_links' => {
        datatype => 'WebsocketsResponseLinksGetAllServicesLinks',
        base_name => '_links',
        description => '',
        format => '',
        read_only => 'false',
...
__PACKAGE__->openapi_types( {
    ...
    '_links' => 'WebsocketsResponseLinksGetAllServicesLinks'
} );
