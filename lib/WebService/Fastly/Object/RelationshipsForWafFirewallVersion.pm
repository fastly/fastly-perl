...
#
package WebService::Fastly::Object::RelationshipsForWafFirewallVersion;
...
__PACKAGE__->method_documentation({
    'waf_firewall_versions' => {
        ...
        base_name => 'waf_firewall_versions',
        description => '',
        format => '',
        read_only => 'false',
            },
    'waf_active_rules' => {
        datatype => 'RelationshipWafActiveRulesWafActiveRules',
        base_name => 'waf_active_rules',
        description => '',
        format => '',
        read_only => 'false',
            },
...
__PACKAGE__->openapi_types( {
    'waf_firewall_versions' => 'RelationshipWafFirewallVersionWafFirewallVersion',
    'waf_active_rules' => 'RelationshipWafActiveRulesWafActiveRules'
} );
