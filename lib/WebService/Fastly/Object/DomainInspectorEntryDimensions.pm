...
#
package WebService::Fastly::Object::DomainInspectorEntryDimensions;
...
__PACKAGE__->class_documentation({description => 'The unique combination of dimensions associated with this timeseries.',
...
__PACKAGE__->method_documentation({
    'region' => {
        datatype => 'string',
        base_name => 'region',
        description => 'The geographic region from which the edge responses in this data entry were delivered. If unspecified, results are aggregated across regions.',
        format => '',
        read_only => 'false',
            },
    'datacenter' => {
