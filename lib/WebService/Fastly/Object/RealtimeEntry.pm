...
#
package WebService::Fastly::Object::RealtimeEntry;
...
__PACKAGE__->class_documentation({description => 'A list of records, each representing one second of time. The &#x60;Data&#x60; property provides access to [measurement data](#measurements-data-model) for that time period, grouped in various ways.',
                                  class => 'RealtimeEntry',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'datacenter' => {
        ...
        description => 'Groups [measurements](#measurements-data-model) by POP. See the [POPs API](/reference/api/utils/pops/) for details of POP identifiers.',
        format => '',
        read_only => 'false',
            },
});
