...
#
package WebService::Fastly::Object::IncludedWithWafActiveRuleItem;
...
__PACKAGE__->method_documentation({
    'data' => {
        datatype => 'SchemasWafFirewallVersionData',
        base_name => 'data',
        description => '',
        format => '',
        read_only => 'false',
    ...
    'id' => {
        datatype => 'string',
        base_name => 'id',
        description => 'Alphanumeric string identifying a WAF rule revision.',
        format => '',
        read_only => 'true',
            },
    'attributes' => {
        datatype => 'WafRuleRevisionAttributes',
