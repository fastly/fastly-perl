...
#
package WebService::Fastly::Object::OriginInspectorHistorical;
...
__PACKAGE__->method_documentation({
    ...
    'meta' => {
        datatype => 'OriginInspectorHistoricalMeta',
        base_name => 'meta',
        description => '',
        format => '',
        read_only => 'false',
    ...
    'data' => {
        datatype => 'ARRAY[OriginInspectorHistoricalData]',
        base_name => 'data',
...
__PACKAGE__->openapi_types( {
    'status' => 'string',
    'meta' => 'OriginInspectorHistoricalMeta',
    'msg' => 'string',
    'data' => 'ARRAY[OriginInspectorHistoricalData]'
} );
