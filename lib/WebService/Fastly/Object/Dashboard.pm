...
#
package WebService::Fastly::Object::Dashboard;
...
__PACKAGE__->method_documentation({
    ...
    'created_by' => {
        datatype => 'DashboardPropertyCreatedBy',
    ...
    'updated_by' => {
        datatype => 'DashboardPropertyUpdatedBy',
        base_name => 'updated_by',
        description => '',
        format => '',
        read_only => 'false',
            },
