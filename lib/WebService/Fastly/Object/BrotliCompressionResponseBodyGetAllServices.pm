...
#
package WebService::Fastly::Object::BrotliCompressionResponseBodyGetAllServices;
...
use WebService::Fastly::Object::BrotliCompressionResponseProductProduct;
...
__PACKAGE__->method_documentation({
    'product' => {
        datatype => 'BrotliCompressionResponseProductProduct',
        base_name => 'product',
        description => '',
        format => '',
        read_only => 'false',
    ...
    '_links' => {
        datatype => 'BrotliCompressionResponseLinksGetAllServicesLinks',
        base_name => '_links',
        description => '',
        format => '',
        read_only => 'false',
...
__PACKAGE__->openapi_types( {
    'product' => 'BrotliCompressionResponseProductProduct',
    'customer' => 'BotManagementResponseCustomerCustomer',
    'services' => 'ARRAY[string]',
    '_links' => 'BrotliCompressionResponseLinksGetAllServicesLinks'
} );
