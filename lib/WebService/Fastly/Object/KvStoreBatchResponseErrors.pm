...
#
package WebService::Fastly::Object::KvStoreBatchResponseErrors;
...
__PACKAGE__->method_documentation({
    'key' => {
        datatype => 'string',
        base_name => 'key',
        description => 'The key that the error corresponds to. This field will be empty if the object or one of its fields was not parseable.',
        format => '',
        read_only => 'false',
            },
    'index' => {
