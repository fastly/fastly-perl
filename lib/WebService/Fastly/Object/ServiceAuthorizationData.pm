...
#
package WebService::Fastly::Object::ServiceAuthorizationData;
...
__PACKAGE__->method_documentation({
    'type' => {
        datatype => 'TypeServiceAuthorization',
        base_name => 'type',
        description => '',
        format => '',
        read_only => 'false',
    ...
    'attributes' => {
        datatype => 'ServiceAuthorizationDataAttributes',
    ...
    'relationships' => {
        datatype => 'ServiceAuthorizationDataRelationships',
