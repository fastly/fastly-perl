...
#
package WebService::Fastly::Object::BotManagementResponseBodyGetAllServices;
...
__PACKAGE__->method_documentation({
    ...
    '_links' => {
        datatype => 'BotManagementResponseLinksGetAllServicesLinks',
        base_name => '_links',
        description => '',
        format => '',
        read_only => 'false',
...
__PACKAGE__->openapi_types( {
    ...
    '_links' => 'BotManagementResponseLinksGetAllServicesLinks'
} );
