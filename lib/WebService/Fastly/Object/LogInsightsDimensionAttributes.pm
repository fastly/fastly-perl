...
#
package WebService::Fastly::Object::LogInsightsDimensionAttributes;
...
__PACKAGE__->method_documentation({
    'rate' => {
        datatype => 'double',
        base_name => 'rate',
        description => 'The rate at which the value in the current dimension occurs.',
        format => 'float',
        read_only => 'false',
            },
    'country_chr' => {
        datatype => 'double',
        base_name => 'country_chr',
        description => 'The cache hit ratio for the country.',
        format => 'float',
        read_only => 'false',
            },
    'country_error_rate' => {
        datatype => 'double',
        base_name => 'country_error_rate',
    ...
    'country_request_rate' => {
        datatype => 'double',
        base_name => 'country_request_rate',
...
__PACKAGE__->openapi_types( {
    'rate' => 'double',
    'country_chr' => 'double',
    'country_error_rate' => 'double',
    'country_request_rate' => 'double'
} );
