...
#
package WebService::Fastly::Object::WafFirewallResponseData;
...
__PACKAGE__->method_documentation({
    ...
    'attributes' => {
        datatype => 'WafFirewallResponseDataAttributes',
    ...
    'relationships' => {
        datatype => 'RelationshipWafFirewallVersions',
