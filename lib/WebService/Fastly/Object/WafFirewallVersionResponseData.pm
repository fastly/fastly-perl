...
#
package WebService::Fastly::Object::WafFirewallVersionResponseData;
...
__PACKAGE__->method_documentation({
    'type' => {
        datatype => 'TypeWafFirewallVersion',
        base_name => 'type',
        description => '',
        format => '',
        read_only => 'false',
    ...
    'attributes' => {
        datatype => 'WafFirewallVersionResponseDataAttributes',
    ...
    'id' => {
        datatype => 'string',
        base_name => 'id',
        description => 'Alphanumeric string identifying a Firewall version.',
        format => '',
        read_only => 'true',
            },
    'relationships' => {
        datatype => 'RelationshipsForWafFirewallVersion',
...
__PACKAGE__->openapi_types( {
    ...
    'id' => 'string',
    'relationships' => 'RelationshipsForWafFirewallVersion'
} );
