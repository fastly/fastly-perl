...
#
package WebService::Fastly::Object::DdosProtectionResponseConfigure;
...
use WebService::Fastly::Object::DdosProtectionResponseLinksLinks;
...
__PACKAGE__->method_documentation({
    ...
    'configuration' => {
        datatype => 'DdosProtectionResponseConfigurationConfiguration',
    ...
    '_links' => {
        datatype => 'DdosProtectionResponseLinksLinks',
        base_name => '_links',
        description => '',
        format => '',
        read_only => 'false',
