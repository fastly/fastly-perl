...
#
package WebService::Fastly::Object::TlsBulkCertificateResponseData;
...
__PACKAGE__->method_documentation({
    'type' => {
        datatype => 'TypeTlsBulkCertificate',
        base_name => 'type',
        description => '',
        format => '',
        read_only => 'false',
    ...
    'attributes' => {
        datatype => 'TlsBulkCertificateResponseAttributes',
    ...
    'relationships' => {
        datatype => 'RelationshipsForTlsBulkCertificate',
