...
#
package WebService::Fastly::Object::DashboardItemPropertyVisualizationPropertyConfig;
...
__PACKAGE__->class_documentation({description => '[Configuration options](#visualization-config) for the given visualization.',
