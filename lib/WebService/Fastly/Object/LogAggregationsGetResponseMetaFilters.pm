...
#
package WebService::Fastly::Object::LogAggregationsGetResponseMetaFilters;
...
__PACKAGE__->method_documentation({
    'filter_fields' => {
        datatype => 'ARRAY[LogAggregationsFilterFieldItem]',
...
__PACKAGE__->openapi_types( {
    'filter_fields' => 'ARRAY[LogAggregationsFilterFieldItem]'
} );
