...
#
package WebService::Fastly::Object::LegacyWafFirewall;
...
__PACKAGE__->method_documentation({
    ...
    'rule_statuses_log_count' => {
        datatype => 'int',
        base_name => 'rule_statuses_log_count',
        description => 'The number of rule statuses set to log.',
        format => '',
        read_only => 'false',
            },
    'rule_statuses_block_count' => {
        datatype => 'int',
        base_name => 'rule_statuses_block_count',
        description => 'The number of rule statuses set to block.',
        format => '',
        read_only => 'false',
            },
    'rule_statuses_disabled_count' => {
        datatype => 'int',
        base_name => 'rule_statuses_disabled_count',
        description => 'The number of rule statuses set to disabled.',
        format => '',
        read_only => 'false',
            },
});
