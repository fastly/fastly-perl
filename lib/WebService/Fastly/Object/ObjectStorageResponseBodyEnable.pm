...
#
package WebService::Fastly::Object::ObjectStorageResponseBodyEnable;
...
use WebService::Fastly::Object::ObjectStorageResponseProductProduct;
...
__PACKAGE__->method_documentation({
    'product' => {
        datatype => 'ObjectStorageResponseProductProduct',
        base_name => 'product',
        description => '',
        format => '',
        read_only => 'false',
    ...
    '_links' => {
        datatype => 'ObjectStorageResponseLinksLinks',
        base_name => '_links',
        description => '',
        format => '',
        read_only => 'false',
...
__PACKAGE__->openapi_types( {
    'product' => 'ObjectStorageResponseProductProduct',
    'customer' => 'AiAcceleratorResponseCustomerCustomer',
    '_links' => 'ObjectStorageResponseLinksLinks'
} );
