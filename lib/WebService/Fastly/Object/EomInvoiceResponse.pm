...
#
package WebService::Fastly::Object::EomInvoiceResponse;
...
__PACKAGE__->method_documentation({
    ...
    'monthly_transaction_amount' => {
        datatype => 'double',
        base_name => 'monthly_transaction_amount',
        description => 'Total billable amount for invoiced services charged within a single month.',
        format => '',
        read_only => 'false',
            },
    'transaction_line_items' => {
        datatype => 'ARRAY[Invoicelineitems]',
        base_name => 'transaction_line_items',
        description => '',
        format => '',
        read_only => 'false',
            },
...
__PACKAGE__->openapi_types( {
    ...
    'monthly_transaction_amount' => 'double',
