...
#
package WebService::Fastly::Object::MutualAuthenticationResponseData;
...
use WebService::Fastly::Object::MutualAuthenticationResponseAttributes;
...
__PACKAGE__->method_documentation({
    'type' => {
        datatype => 'TypeMutualAuthentication',
        base_name => 'type',
        description => '',
        format => '',
        read_only => 'false',
    ...
    'attributes' => {
        datatype => 'MutualAuthenticationResponseAttributes',
    ...
    'relationships' => {
        datatype => 'RelationshipsForMutualAuthentication',
