...
#
package WebService::Fastly::Object::Metadata;
...
__PACKAGE__->class_documentation({description => 'Pagination metadata',
                                  class => 'Metadata',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'next_cursor' => {
        ...
        description => 'The token used to request the next set of results.',
        format => '',
        read_only => 'false',
            },
    'limit' => {
