...
#
package WebService::Fastly::Object::EnabledProductResponse;
...
use WebService::Fastly::Object::EnabledProductResponseProduct;
...
__PACKAGE__->method_documentation({
    'product' => {
        datatype => 'EnabledProductResponseProduct',
        base_name => 'product',
        description => '',
        format => '',
        read_only => 'false',
    ...
    '_links' => {
        datatype => 'EnabledProductResponseLinks',
        base_name => '_links',
        description => '',
        format => '',
        read_only => 'false',
