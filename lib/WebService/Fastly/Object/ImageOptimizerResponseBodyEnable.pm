...
#
package WebService::Fastly::Object::ImageOptimizerResponseBodyEnable;
...
use WebService::Fastly::Object::ImageOptimizerResponseService;
...
__PACKAGE__->method_documentation({
    ...
    '_links' => {
        datatype => 'ImageOptimizerResponseLinksLinks',
        base_name => '_links',
        description => '',
        format => '',
        read_only => 'false',
