...
#
package WebService::Fastly::Object::TlsConfigurationResponseData;
...
__PACKAGE__->method_documentation({
    ...
    'attributes' => {
        datatype => 'TlsConfigurationResponseAttributes',
    ...
    'relationships' => {
        datatype => 'RelationshipsForTlsConfiguration',
