...
#
package WebService::Fastly::ObjectStoreItemApi;
...
# @param boolean $force  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_key_from_store' } = {
        summary => 'Delete object store item.',
        params => $params,
        returns => undef,
        };
}
...
sub delete_key_from_store {
    ...
    # parse inputs
    my $_resource_path = '/resources/stores/object/{store_id}/keys/{key_name}';
...
sub get_keys {
    ...
    # parse inputs
    my $_resource_path = '/resources/stores/object/{store_id}/keys';
...
# @param string $key_name  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_value_for_key' } = {
        summary => 'Get the value of an object store item',
        params => $params,
        returns => 'string',
        };
}
...
# @param string $body  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'set_value_for_key' } = {
        summary => 'Insert an item into an object store',
        params => $params,
        returns => 'string',
        };
}
