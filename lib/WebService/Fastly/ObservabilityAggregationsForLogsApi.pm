...
#
package WebService::Fastly::ObservabilityAggregationsForLogsApi;
...
# @param string $sort  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'log_aggregations_get' } = {
        summary => 'Retrieve aggregated log results',
        params => $params,
        returns => 'LogAggregationsGetResponse',
        };
}
# @return LogAggregationsGetResponse
#
sub log_aggregations_get {
    my ($self, %args) = @_;

    # verify the required parameter 'source' is set
    unless (exists $args{'source'}) {
      croak("Missing the required parameter 'source' when calling log_aggregations_get");
    }

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling log_aggregations_get");
    }

    # verify the required parameter 'start' is set
    unless (exists $args{'start'}) {
      croak("Missing the required parameter 'start' when calling log_aggregations_get");
    }

    # verify the required parameter 'end' is set
    unless (exists $args{'end'}) {
      croak("Missing the required parameter 'end' when calling log_aggregations_get");
    }

    # verify the required parameter 'series' is set
    unless (exists $args{'series'}) {
      croak("Missing the required parameter 'series' when calling log_aggregations_get");
    }

    # parse inputs
    my $_resource_path = '/observability/aggregations';
    ...
    my $_response_object = $self->{api_client}->deserialize('LogAggregationsGetResponse', $response);
