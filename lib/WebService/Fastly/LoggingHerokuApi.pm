...
#
package WebService::Fastly::LoggingHerokuApi;
...
# @param string $url The URL to stream logs to. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_log_heroku' } = {
        summary => 'Create a Heroku log endpoint',
        params => $params,
        returns => 'LoggingHerokuResponse',
        };
}
# @return LoggingHerokuResponse
#
sub create_log_heroku {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling create_log_heroku");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling create_log_heroku");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/heroku';
    ...
    my $_response_object = $self->{api_client}->deserialize('LoggingHerokuResponse', $response);
...
# @param string $service_id Alphanumeric string identifying the service. (required)
# @param int $version_id Integer identifying a service version. (required)
# @param string $logging_heroku_name The name for the real-time logging configuration. (required)
{
    my $params = {
    'service_id' => {
        data_type => 'string',
    ...
    __PACKAGE__->method_documentation->{ 'delete_log_heroku' } = {
...
#
sub delete_log_heroku {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling delete_log_heroku");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling delete_log_heroku");
    }

    # verify the required parameter 'logging_heroku_name' is set
    unless (exists $args{'logging_heroku_name'}) {
      croak("Missing the required parameter 'logging_heroku_name' when calling delete_log_heroku");
    }

    # parse inputs
    my $_resource_path = '/service/{service_id}/version/{version_id}/logging/heroku/{logging_heroku_name}';
    ...
    # path params
    if ( exists $args{'logging_heroku_name'}) {
        my $_base_variable = "{" . "logging_heroku_name" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'logging_heroku_name'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
...
# @param string $logging_heroku_name The name for the real-time logging configuration. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_log_heroku' } = {
...
sub get_log_heroku {
    ...
    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling get_log_heroku");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling get_log_heroku");
    }

    # verify the required parameter 'logging_heroku_name' is set
    unless (exists $args{'logging_heroku_name'}) {
      croak("Missing the required parameter 'logging_heroku_name' when calling get_log_heroku");
    }
...
# @param int $version_id Integer identifying a service version. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_log_heroku' } = {
        summary => 'List Heroku log endpoints',
        params => $params,
        returns => 'ARRAY[LoggingHerokuResponse]',
        };
}
...
sub list_log_heroku {
    ...
    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling list_log_heroku");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling list_log_heroku");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[LoggingHerokuResponse]', $response);
    return $_response_object;
}
...
# @param string $url The URL to stream logs to. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_log_heroku' } = {
...
# @return LoggingHerokuResponse
#
sub update_log_heroku {
    my ($self, %args) = @_;

    # verify the required parameter 'service_id' is set
    unless (exists $args{'service_id'}) {
      croak("Missing the required parameter 'service_id' when calling update_log_heroku");
    }

    # verify the required parameter 'version_id' is set
    unless (exists $args{'version_id'}) {
      croak("Missing the required parameter 'version_id' when calling update_log_heroku");
    }

    # verify the required parameter 'logging_heroku_name' is set
    unless (exists $args{'logging_heroku_name'}) {
      croak("Missing the required parameter 'logging_heroku_name' when calling update_log_heroku");
    }
